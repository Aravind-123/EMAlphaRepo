...
<<<<<<< HEAD
	...
	case "td":
			...
			try{
		   element1=waitele.until(ExpectedConditions.elementToBeClickable(By.xpath("//td[@class='"+ProValue1+"' or @tabIndex='"+AddProValue+"' or contains(@onclick 'selectThemeFunction']")));
			}
			catch(Exception e)
			{
...
<<<<<<< HEAD
   ...
   result="PASS";
   comments="WebEdit Content Deleted";
  ResultReporting.printresult(filePath,workbook,step_Report,checkPointsh,module1,modFunc1,result,comments,TestScenarioRow);
              }
              else{
                    result="FAIL";
         comments="WebEdit Content  not Deleted";
  ResultReporting.printresult(filePath,workbook,step_Report,checkPointsh,module1,modFunc1,result,comments,TestScenarioRow);
  }
break;
		case "BackSpace":
            WebElement ele6=waitele.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='"+value+"']")));
            if(ele6.isDisplayed()){
 ...
 robot2.keyRelease(KeyEvent.VK_BACK_SPACE);
 result="PASS";
 comments="WebEdit Content Deleted";
ResultReporting.printresult(filePath,workbook,step_Report,checkPointsh,module1,modFunc1,result,comments,TestScenarioRow);
            }
